...
const traduction = {
    ...
    fr : {
        ...
        vsCodeDescription : "Éditeur de code léger, puissant et polyvalent, incontournable pour les développeurs web. Il offre de nombreuses fonctionnalités, prend en charge plusieurs langages, permet des extensions personnalisables et s'intègre parfaitement aux outils de contrôle de version. Sa convivialité et ses mises à jour régulières en font un choix privilégié pour les développeurs.",
        gimpDescription: "Solution gratuite et puissante d'édition de photos, rivalisant avec des logiciels propriétaires. Il propose des fonctionnalités avancées pour la retouche d'images, avec des outils tels que les calques, les filtres et la retouche non destructive. GIMP offre une liberté créative sans compromis et convient aux créatifs et aux professionnels.",
        notionDescription : "Plateforme tout-en-un révolutionnaire pour la gestion des tâches, la collaboration et la création de contenu. Elle combine des fonctionnalités de prise de notes, de gestion de projet, de bases de données et plus encore, offrant une flexibilité exceptionnelle. Notion est une solution polyvalente qui permet aux utilisateurs de personnaliser et de structurer leurs pages selon leurs besoins, que ce soit pour la gestion de tâches personnelles ou de projets d'équipe complexes.",
    ...
    en : {  
        ...
        vsCodeDescription: "A lightweight, powerful, and versatile code editor that has become a developer's top choice for web development. It offers numerous features, supports multiple languages, allows for customizable extensions, and seamlessly integrates with version control tools. Its user-friendly interface and regular updates make it a must-have tool for developers.",
        gimpDescription: "A free and powerful photo editing solution that competes with proprietary image editing software. It provides advanced features for image retouching, including layers, filters, and non-destructive editing. GIMP offers uncompromised creative freedom and is suitable for both creatives and professionals.",
        notionDescription : "A revolutionary all-in-one platform for task management, collaboration, and content creation. By combining note-taking, project management, databases, and more, Notion offers exceptional flexibility. Users can create and structure custom pages to meet their specific needs, whether for personal task tracking or complex team project management. In summary, Notion is a versatile tool that redefines how we organize and collaborate, offering a modern and intuitive approach to productivity.",
